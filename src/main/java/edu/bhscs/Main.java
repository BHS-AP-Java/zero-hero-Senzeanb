...
public class Main {
  public static void main(String[] arges) {
    ...
    Cake blueberryCake = new Cake(
        "Blueberry cheesecake",
        new String[] {"flour", "blueberry extract", "cream cheese", "butter", "6 eggs", "1 cup of whole milk", "1/4 cup butter", "1 cup condensed milk"}
    );
    System.out.println("Cake flavor: " + blueberryCake.getFlavor() + " (shape: " + blueberryCake.getShape() + ") is a hit and everyone loves it!");
    ...
    for (int i = 0; i < 3; i++) {
        if (sophia.buyCake(cakePrice)) {
            baker.sellCake();
            sophiasCakes[i] = new Cake(
                cakeFlavor,
                new String[] {"flour", "blueberry extract", "cream cheese", "butter", "eggs", "whole milk", "sugar"}
            );
        }
    }
    ...
    for (int i = 0; i < sophiasCakes.length; i++) {
        System.out.println("Cake " + (i+1) + ": " + sophiasCakes[i].getFlavor() + ", shape: " + sophiasCakes[i].getShape());
    ...
    System.out.println("Sophia's Cakes Owned: " + sophia.getCakesOwned() + " (all " + cakeFlavor + ")");
